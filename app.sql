...
--
-- Хост: mysql
-- Время создания: Фев 13 2024 г., 18:28
...
(5, 1, NULL, 'Ніколи не їж огірки з холодильника самотньої жінки', 1, 25, '2023-03-11 20:14:00', '2024-02-13 11:13:23', NULL),
...
(8, 1, NULL, 'Я знаю що порожнечу моєї душі не заповнити олів\'є, але я намагатимусь знову і знову', 0, 27, '2023-03-11 20:27:00', '2024-02-13 11:07:20', NULL),
(9, 1, NULL, 'Маша мала такі гарні губи, що через них не могла завагітніти', 0, 4, '2023-03-11 20:28:00', '2024-02-13 11:07:22', NULL),
(10, 1, NULL, 'Як хочеться колись покласти лимон не в чай, а в швейцарський банк', 1, 4, '2023-03-11 20:29:00', '2024-02-13 11:06:37', NULL),
(11, 1, NULL, 'Подаруй людині рибу - і він буде ситий весь день. \nПодаруй людині вудку - і можеш шпилити його дружину всі вихідні', 6, 39, '2023-03-11 20:32:00', '2024-02-13 11:07:25', NULL),
(12, 1, NULL, 'Настрій. Хочеться рожеве шампанське та біляш', 2, 6, '2023-03-11 20:33:00', '2024-02-13 15:34:25', NULL),
...
(15, 1, NULL, 'Якщо в тебе немає мужика, то швидше за все ти дox@я вумная', 0, 43, '2023-03-11 20:38:00', '2024-02-13 11:05:30', NULL),
(16, 1, NULL, 'Біле сухе – це моє обличчя взимку', 0, 45, '2023-03-11 20:38:00', '2024-02-13 11:04:44', NULL),
(17, 1, NULL, 'Ти ж мій пончик\nБо товста?\nНі тому що солодка і з дирочкою)', 0, 48, '2023-03-26 18:31:00', '2024-02-13 11:04:29', NULL),
(18, 1, NULL, 'Як кажуть справжні чоловіки - побачимо', 0, 49, '2023-03-26 18:32:00', '2024-02-13 11:04:11', NULL),
(19, 1, NULL, 'Альфа салец', 3, 50, '2023-03-26 18:34:00', '2024-02-13 11:03:58', NULL),
(20, 1, NULL, 'Як казав Джейсон Стетхем - одна помилка і ти помилився', 0, 50, '2023-03-26 18:34:00', '2024-02-13 11:03:49', NULL),
(21, 1, NULL, 'Там де темно там приємно', 0, 51, '2023-03-26 18:35:00', '2024-02-13 11:03:36', NULL),
(22, 1, NULL, 'Арівідрочіі', 2, 53, '2023-03-26 18:35:00', '2024-02-13 11:03:28', NULL),
(23, 0, NULL, 'Усе стабільно але дебільно', 8, 56, '2023-03-26 18:35:00', '2024-02-13 11:03:27', NULL),
(33, 1, NULL, 'Навіщо самураю меч, якщо він не в крові', 0, 21, '2024-02-10 20:05:00', '2024-02-13 11:11:53', 1),
(34, 1, NULL, 'Якщо ви зустріли класну бабу яка слухає рок, читає книги та розуміє сарказм, то зараз продзвенить будильник', 1, 35, '2024-02-11 15:49:39', '2024-02-13 11:13:23', 1),
(35, 1, NULL, 'Ти все?\nніжно запитала самка богомола', 1, 25, '2024-02-11 15:55:00', '2024-02-13 11:13:23', 1),
(36, 1, NULL, 'Боксера може образити кожен, але не кожен встигне вибачитись', 0, 17, '2024-02-11 18:24:51', '2024-02-13 06:50:54', 1),
(37, 1, NULL, 'Знаєш як москалі називають наше шалене кохання - близость', 0, 21, '2024-02-11 18:26:14', '2024-02-13 11:13:27', 1),
(38, 1, NULL, 'У мене два недоліки: погана пам\'ять і ще щось...', 0, 22, '2024-02-11 18:31:13', '2024-02-13 17:49:26', 1),
(39, 1, NULL, 'Як краса може врятувати світ, якщо вона постійно потребує жертв?', 0, 23, '2024-02-11 18:37:11', '2024-02-13 17:49:26', 1),
(40, 1, NULL, '- Рабіновичу, у вас є гроші?\n- Ну якісь є... Якихось немає...', 1, 23, '2024-02-11 18:39:00', '2024-02-13 17:49:26', 1),
(41, 1, NULL, '-Ти обіцяв на мені одружитися!\n-Та мало що я на тобі обіцяв.', 1, 20, '2024-02-11 19:03:00', '2024-02-13 17:49:26', 1),
(43, 1, NULL, 'Завдавати добро і наносити користь', 0, 20, '2024-02-12 17:50:13', '2024-02-13 17:49:26', 1),
(44, 1, NULL, 'Хорошого бухгалтера знайти важко, тому Віра Павлівна вже двадцять років перебуває в розшуку', 0, 10, '2024-02-13 06:37:40', '2024-02-13 17:49:26', 1),
(45, 1, NULL, 'У мене немає ні сорому, ні совісті… Нічого зайвого', 0, 10, '2024-02-13 06:48:00', '2024-02-13 17:49:26', 1),
(46, 1, NULL, 'Скупий платить двічі... Влаштуюсь-ка я на роботу до скупого!', 0, 9, '2024-02-13 06:50:40', '2024-02-13 17:49:26', 1),
(49, 1, NULL, 'Хочеться простого людського зіпсувати комусь життя', 0, 9, '2024-02-13 10:52:45', '2024-02-13 17:49:26', 1),
(50, 1, NULL, 'Давай губи накачаємо, я втомилася розвиватися', 0, 4, '2024-02-13 11:34:50', '2024-02-13 17:49:26', 1);
...
(2, 1, 'вареник', 1, '2023-03-03 21:04:45', '2024-01-14 08:49:16'),
...
(39, NULL, 'жертв', 1, '2024-02-11 18:39:06', '2024-02-11 18:53:36'),
...
(69, NULL, 'пончик', 1, '2024-02-13 11:04:29', '2024-02-13 11:04:29'),
(70, NULL, 'дирочка', 1, '2024-02-13 11:04:29', '2024-02-13 11:04:29'),
(71, NULL, 'вино', 1, '2024-02-13 11:04:44', '2024-02-13 11:04:44'),
...
(84, NULL, 'олівье', 1, '2024-02-13 11:07:20', '2024-02-13 11:07:20'),
...
(88, NULL, 'лимон', 1, '2024-02-13 11:07:23', '2024-02-13 11:07:23'),
...
(94, NULL, 'риба', 1, '2024-02-13 11:07:25', '2024-02-13 11:07:25'),
(95, NULL, 'біляш', 1, '2024-02-13 11:07:27', '2024-02-13 11:07:27'),
...
(103, NULL, 'огірки', 1, '2024-02-13 11:08:36', '2024-02-13 11:08:36'),
...
(125, NULL, 'саморозвиток', 1, '2024-02-13 11:35:29', '2024-02-13 11:35:29'),
